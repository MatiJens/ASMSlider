...
apptainer exec --nv \
    ...
    "$SIF_IMAGE" \
    python /mnt/magisterka/scripts/mlp/create_mlp.py \
        --input-path /mnt/magisterka/configs/mlp_config.json \
        -o /mnt/lustre/models
